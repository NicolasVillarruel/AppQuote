      ...
      <Page size="A4" style={S.page}>
        ...
        <View style={S.infoRow}>
          ...
          <View style={S.infoBox}>
            ...
            <Text style={[S.infoSmall, { marginTop: 8 }]}>
              Tasa cambio EUR/PEN: {formatNumber(cot.tasa_cambio_eur_pen, 3)} | USD/PEN: {formatNumber(cot.tasa_cambio_usd_pen || 3.75, 3)}
              {"\n"}
              (Ref. al {fechaEmision})
            </Text>
          </View>
        ...
        <View style={S.validezBox}>
          ...
          <Text style={[S.validezText, { marginTop: 4 }]}>
            * Los precios en soles fueron calculados con tipo de cambio EUR/PEN de {formatNumber(cot.tasa_cambio_eur_pen, 3)} y USD/PEN de {formatNumber(cot.tasa_cambio_usd_pen || 3.75, 3)} (referencial al {fechaEmision}).
