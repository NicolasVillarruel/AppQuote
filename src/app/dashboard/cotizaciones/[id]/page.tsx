      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border bg-card p-5 space-y-1">
          ...
          <div className="pt-3 mt-3 border-t border-border/40">
            <p className="text-xs text-muted-foreground">TC Referencial:</p>
            <p className="text-xs text-muted-foreground">EUR/PEN {formatNumber(cot.tasa_cambio_eur_pen, 3)} | USD/PEN {formatNumber(cot.tasa_cambio_usd_pen || 3.75, 3)}</p>
            <p className="text-[10px] text-muted-foreground/70 mt-0.5">Fecha TC: {formatDate(cot.created_at)}</p>
          </div>
        </div>
